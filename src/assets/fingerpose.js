        ...
        return function (t) {
            ...
            var d = function () {
                ...
                return e = t, (n = [{
                    key: "estimate", value: function (t) {
                        ...
                        try {
                            for (i.s(); !(e = i.n()).done;) {
                                ...
                                try {
                                    for (h.s(); !(a = h.n()).done;) {
                                        var d = a.value, p = t[d[0]], y = t[d[1]], g = this.getSlopes(p, y), v = g[0],
                                            m = g[1];
                                        f.push(v), s.push(m)
                                    }
                                } catch (t) {
                        ...
                        try {
                            for (O.s(); !(b = O.n()).done;) {
                                var M = b.value, S = M == o.Thumb ? 1 : 0, T = o.getPoints(M), C = t[T[S][0]],
                                    R = t[T[S + 1][1]], A = t[T[3][1]], L = this.estimateFingerCurl(C, R, A),
                    ...
                    key: "getSlopes", value: function (t, e) {
                        var n = this.calculateSlope(t[0], t[1], e[0], e[1]);
                        return 2 == t.length ? n : [n, this.calculateSlope(t[1], t[2], e[1], e[2])]
                    }
                }, {
                    key: "angleOrientationAt", value: function (t) {
                        var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 1, n = 0, r = 0, i = 0;
                        return t >= 75 && t <= 105 ? n = 1 * e : t >= 25 && t <= 155 ? r = 1 * e : i = 1 * e, [n, r, i]
                    }
                }, {
                    key: "estimateFingerCurl", value: function (t, e, n) {
                        var r = t[0] - e[0], i = t[0] - n[0], o = e[0] - n[0], l = t[1] - e[1], u = t[1] - n[1],
                            c = e[1] - n[1], f = t[2] - e[2], s = t[2] - n[2], h = e[2] - n[2],
                            d = Math.sqrt(r * r + l * l + f * f), p = Math.sqrt(i * i + u * u + s * s),
                            y = Math.sqrt(o * o + c * c + h * h), g = (y * y + d * d - p * p) / (2 * y * d);
                        g > 1 ? g = 1 : g < -1 && (g = -1);
                        var v = Math.acos(g);
                    ...
                    key: "estimateHorizontalDirection", value: function (t, e, n, r) {
                    ...
                    key: "estimateVerticalDirection", value: function (t, e, n, r) {
                    ...
                    key: "estimateDiagonalDirection", value: function (t, e, n, r, i, o, a, u) {
                    ...
                    key: "calculateFingerDirection", value: function (t, e, n, r) {
                        var i = t[0] - e[0], o = t[0] - n[0], a = e[0] - n[0], l = t[1] - e[1], c = t[1] - n[1],
                            f = e[1] - n[1], s = Math.max(Math.abs(i), Math.abs(o), Math.abs(a)),
                            h = Math.max(Math.abs(l), Math.abs(c), Math.abs(f)), d = 0, p = 0, y = 0, g = h / (s + 1e-5);
                        g > 1.5 ? d += this.options.DISTANCE_VOTE_POWER : g > .66 ? p += this.options.DISTANCE_VOTE_POWER : y += this.options.DISTANCE_VOTE_POWER;
                        var v = Math.sqrt(i * i + l * l), m = Math.sqrt(o * o + c * c), b = Math.sqrt(a * a + f * f),
                            D = Math.max(v, m, b), w = t[0], O = t[1], M = n[0], S = n[1];
                        D == v ? (M = n[0], S = n[1]) : D == b && (w = e[0], O = e[1]);
                        var T = [w, O], C = [M, S], R = this.getSlopes(T, C),
                            A = this.angleOrientationAt(R, this.options.TOTAL_ANGLE_VOTE_POWER);
                        d += A[0], p += A[1], y += A[2];
                        var L, _ = u(r);
                        try {
                            for (_.s(); !(L = _.n()).done;) {
                                var j = L.value, E = this.angleOrientationAt(j, this.options.SINGLE_ANGLE_VOTE_POWER);
                                d += E[0], p += E[1], y += E[2]
                            }
                        } catch (t) {
                            _.e(t)
                    ...
                    key: "calculateSlope", value: function (t, e, n, r) {
                        var i = (e - r) / (t - n), o = 180 * Math.atan(i) / Math.PI;
            ...
            var m = (function () {
              ...
              var signList = [
                ...
                // },
                {
                  ...
                  // sharchop: "./assets/files/lalit.m4a",
                  // nepali: "./assets/files/lalit.m4a",
                  en: "./assets/files/A-EN.m4a",
                  sign: "Thumb,No Curl,Diagonal Up Left,Index,Full Curl,Diagonal Up Left,Middle,Full Curl,Diagonal Up Left,Ring,Full Curl,Vertical Up,Pinky,Full Curl,Vertical Up"
                },
                {
                  text: "C",
                  // dzo: "./assets/files/lalit.m4a",
                  // sharchop: "./assets/files/lalit.m4a",
                  // nepali: "./assets/files/lalit.m4a",
                  en: "./assets/files/C-en.m4a",
                  sign: "Thumb,No Curl,Diagonal Up Left,Index,Half Curl,Diagonal Up Left,Middle,Half Curl,Diagonal Up Left,Ring,Half Curl,Diagonal Up Left,Pinky,Half Curl,Diagonal Up Left",
                },
                {
                  text: "L",
                  dzo: "./assets/files/lalit.m4a",
                  sharchop: "./assets/files/lalit.m4a",
                  nepali: "./assets/files/lalit.m4a",
                  en: "./assets/files/L-en.m4a",
                  sign: "Thumb,No Curl,Diagonal Up Left,Index,No Curl,Vertical Up,Middle,Full Curl,Vertical Up,Ring,Full Curl,Vertical Up,Pinky,Full Curl,Diagonal Up Right",
                },
                {
                  text: "I",
                // dzo: "./assets/files/lalit.m4a",
                // sharchop: "./assets/files/lalit.m4a",
                // nepali: "./assets/files/lalit.m4a",
                en: "./assets/files/I-en.m4a",
                  sign: "Thumb,Half Curl,Vertical Up,Index,Full Curl,Diagonal Up Left,Middle,Full Curl,Vertical Up,Ring,Full Curl,Vertical Up,Pinky,No Curl,Vertical Up"
                },
                {
                  text: "T",
                // dzo: "./assets/files/lalit.m4a",
                // sharchop: "./assets/files/lalit.m4a",
                // nepali: "./assets/files/lalit.m4a",
                en: "./assets/files/T-en.m4a",
                  sign: "Thumb,No Curl,Vertical Up,Index,Full Curl,Vertical Up,Middle,Full Curl,Vertical Up,Ring,Full Curl,Vertical Up,Pinky,Full Curl,Diagonal Up Right"
                },
                {
                  text: "Demo",
                ...
                },
                {
                  ...
                  // nepali: "./assets/files/lalit.m4a",
                  // en: "./assets/files/lalit.m4a",
                  sign: "Thumb,No Curl,Diagonal Up Left,Index,No Curl,Vertical Up,Middle,No Curl,Diagonal Up Left,Ring,No Curl,Diagonal Up Left"
                },
                {
                  text: "Amazing",
                  // dzo: "./assets/files/lalit.m4a",
                  // sharchop: "./assets/files/lalit.m4a",
                  nepali: "./assets/files/Amazing-Nepali.m4a",
                  // en: "./assets/files/lalit.m4a",
                  sign: "Thumb,No Curl,Diagonal Up Left,Index,Full Curl,Diagonal Up Left,Middle,Full Curl,Vertical Up,Ring,Full Curl,Vertical Up,Pinky,No Curl,Vertical Up"
                },
                {
                  text: "NGA",
                  dzo: "./assets/files/NGA-DZO.m4a",
                  // sharchop: "./assets/files/lalit.m4a",
                  // nepali: "./assets/files/lalit.m4a",
                  // en: "./assets/files/lalit.m4a",
                  sign: 'Thumb,Half Curl,Diagonal Up Left,Index,Full Curl,Diagonal Up Left,Middle,Full Curl,Diagonal Up Left,Ring,Full Curl,Horizontal Left,Pinky,No Curl,Horizontal Left'
                }
            ...
            var S = function () {
                ...
                return e = t, (n = [{
                    ...
                    key: "matchAgainst", value: function (t, e) {
                        var n = 0;
                        for (var r in t) {
                            var i = t[r], o = this.curls[r];
                            if (void 0 !== o) {
                                var a, l = D(o);
                                try {
                                    for (l.s(); !(a = l.n()).done;) {
                                        var u = b(a.value, 2), c = u[0], f = u[1];
                                        if (i == c) {
                        ...
                        for (var s in e) {
                            var h = e[s], d = this.directions[s];
                            if (void 0 !== d) {
                                var p, y = D(d);
                                try {
                                    for (y.s(); !(p = y.n()).done;) {
                                        var g = b(p.value, 2), v = g[0], m = g[1];
                                        if (h == v) {
            ...
            T.addCurl(o.Thumb, a.HalfCurl, .5),
                ...
                T.setWeight(o.Index, 2), T.setWeight(o.Middle, 2);
            var C = T, R = new S("thumbs_up");
            ...
            var j = R;
            e.default = {
                GestureEstimator: m, GestureDescription: S, Finger: o, FingerCurl: a, FingerDirection: l, Gestures: r
            }
        }
        ]).default
    })
